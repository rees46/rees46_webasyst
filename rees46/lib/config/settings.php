    ...
    'is_batch' => array(
        ...
        'options' => array(
            array(
                ...
                'description' => 'Режим пакетной установки автоматически устанавливает блоки рекомендаций на главную страницу и страницу корзины.<br>Установка дополнительных блоков на страницу категории и страницу карточки товара необходимо выполнить самостоятельно,<br>блоки при этом будут установлены пакетно.<br>',
            ),
            array(
                'value' => 0,
